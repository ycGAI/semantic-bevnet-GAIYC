...
def plot_concatenated_comparison():
    ...
    models = {
        'default': {
            'dir': 'default---n_frame=2-logs',
            'color': '#808080',
            'marker': 'o',
            'name': 'Default (Baseline)'
        },
        # 'se_classifier_only': {
        #     'dir': 'se_classifier_only---n_frame=2-logs',
        #     'color': '#3498db',
        #     'marker': 's',
        #     'name': 'SE Classifier Only'
        # },
        'se_attention': {
            'dir': 'se_attention---n_frame=2-logs',
            'color': '#e74c3c',
            'marker': '^',
            'name': 'SE Attention'
        },
        'self_attention': {
            'dir': 'self_attention---n_frame=2-logs',
            'color': '#2ecc71',
            'marker': 'D',
            'name': 'Self Attention'
        },
        'cbam_attention': {
            'dir': 'cbam_attention---n_frame=2-logs',
            'color': '#f39c12',
            'marker': 'v',
            'name': 'CBAM Attention'
        },
        'se_self_attention': {
            'dir': 'se_self_attention---n_frame=2-logs',
            'color': '#9b59b6',
            'marker': '*',
